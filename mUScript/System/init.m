...
CProc["musystem", Quiet, DownValues, UpValues, Protect, Unprotect, ListQ, NumericQ, Rest, Prepend, Dimensions, LeafCount, Min, Max]
...
CProc["musystem", ReplacePart, Prepend,Append,Reverse,Distribute, Symbols, List, Count, Union, Verbose,DownValuesDefaultType]
